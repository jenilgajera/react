    ...
    <div className="container">
      ...
      <div className="card mt-4">
        <div className="card-body">
          <h2>About Us</h2>
          <p>
            Welcome to our application! This app is designed to help you manage
            your financial transactions, monitor your expenses, and much more.
            We are dedicated to providing an easy and intuitive platform for
            financial management.
          </p>
          <p>
            Our goal is to make finance simple and accessible for everyone.
            Learn more about the features and services we offer by navigating
            through our website.
          </p>
        </div>
      </div>
